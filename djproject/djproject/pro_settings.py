...
SECRET_KEY = '3s+m3x^g_p4wdq5%)0m(r7(ol6(6h9e%m(0c=qx$hidluo@fi9'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'INDEX_NAME': 'djproject',  # 指定elasticsearch建立的索引库的名称
    },
}
...
DATABASES = {
    'default': {
        ...
        'OPTIONS':{
            'read_default_file':'utils/dbs/dbinfo',
        }
    }
}
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, "logs/BAKA.log"),  # 日志文件的存放位置
